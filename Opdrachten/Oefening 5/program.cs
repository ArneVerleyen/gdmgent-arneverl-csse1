...
namespace oefening5
{
    ...
    {   
            ...
            static int Som(int get1 = 5, int get2 = 6){
                return get1 + get2;
            }

            static int Verschil(int get1 = 8, int get2 = 5){
                return get1 - get2;
            }

             static double Quotiënt(int get1 = 8, int get2 = 4){
                return (double)get1 / get2;
            }

            static int Product(int get1 = 5 , int get2 = 3){
                return get1 * get2;
            }

            static int Modulo(int getal1 = 9, int getal2 = 2){
                return getal1%getal2;
            }
            static int Verhogen(int getal = 7){
                return ++getal;
            }

            static int Verlagen(int getal = 8){
                return --getal;
            }
